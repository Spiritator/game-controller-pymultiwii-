        ...
        while done==False:
           ...
           # controller.update()
            ...
            #example of 4 RC channels to be send
                ...
                rotate=int(controller.get_axis(2)*(-1)*sensitivity+1500)
                if abs(controller.get_axis(1))>=0.1 and throttle>=1000 and throttle<=2000:
                    throttle=throttle+int(controller.get_axis(1)*(-5))
                elif throttle>2000:
                    throttle=2000
                elif throttle<1000:
                    throttle=1000
