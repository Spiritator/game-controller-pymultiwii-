...
#This code using American Hand way to control the drone. For other ways check out other codes in the same repository file folder
    ...
    try:
        ...
        while done==False:
            ...
            if controller.B:
                ...
                rotate=int(controller.a_joystick_left_x*sensitivity+1500)
                if controller.a_joystick_left_y<0:
                    throttle=int(controller.a_joystick_left_y*((-2)*sensitivity)+1000)
                else:
                    throttle=1000 
